                    ...
                    <div class="col-12">
                        ...
                        <!-- <form> -->
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="รหัสบัตรประชาชน" disabled>
                            </div>
                            <div class="form-group">
                                <label for="name">ชื่อ</label>
                                <input type="text" class="form-control" value="ชื่อ" disabled>
                            </div>
                            <div class="form-group">
                                <label for="name">นามสกุล</label>
                                <input type="text" class="form-control" value="สกุล" disabled>
                            </div>
                            <div class="form-group">
                                <label for="email">อีเมล</label>
                                <input type="email" class="form-control"  value="อีเมล" disabled>
                            </div>
                            <div class="form-group">
                                <label for="email">เบอร์</label>
                                <input type="tel" class="form-control"  value="เบอร์"disabled >
                            </div>
                            <h5 class="mb-4 font-weight-bold">ข้อมูลล็อกอิน</h5>
                            <div class="form-group">
                                <label for="email">ชื่อผู้ใช้</label>
                                <input type="tel" class="form-control"  value="ชื่อผู้ใช้" disabled>
                            </div>
                            <div class="form-group">
                                <label for="email">รหัสผ่าน</label>
                                <input type="password" class="form-control"  value="รหัสผ่าน"disabled >
                            </div>
                            <div class="form-group">
                                <button onclick="location.assign('./edit_profile.php?id=1')" class="btn btn-primary">แก้ไข</button>
                            </div>
                        <!-- </form> -->
                    </div>
                </div>
