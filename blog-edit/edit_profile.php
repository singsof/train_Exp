    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="container py-5 px-2 bg-white">
                <div class="row px-4">
                    <div class="col-12">
                        <h3 class="mb-4 font-weight-bold">แก้ไขโปรไฟล์</h3>
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="ชื่อ">
                            </div>
                            <div class="form-group">
                                <label for="name">นามสกุล</label>
                                <input type="text" class="form-control" value="สกุล">
                            </div>
                            <div class="form-group">
                                <label for="email">อีเมล</label>
                                <input type="email" class="form-control"  value="อีเมล" >
                            </div>
                            <div class="form-group">
                                <label for="email">เบอร์</label>
                                <input type="tel" class="form-control"  value="เบอร์" >
                            </div>
                            <h5 class="mb-4 font-weight-bold">ข้อมูลล็อกอิน</h5>
                            <div class="form-group">
                                <label for="email">ชื่อผู้ใช้</label>
                                <input type="tel" class="form-control"  value="ชื่อผู้ใช้" >
                            </div>
                            <div class="form-group">
                                <label for="email">รหัสผ่าน</label>
                                <input type="password" class="form-control"  value="รหัสผ่าน" >
                            </div>
                            <div class="form-group">
