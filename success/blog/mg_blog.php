    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="container bg-white pt-5">
                <table id="table_id_B" class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php 
                            $i = null; 
                            foreach(Database::query("SELECT *, DATE_FORMAT(date_blog, '%W %M %Y') as dTime FROM `blog` WHERE id_mem='$ID_MEM'",PDO::FETCH_OBJ) as $key) :
                        ...
                        <tr>
                            ...
                            <td><a href="detail_blog.php?id_blog=<?php echo $key->id_blog ?>"><?php echo $key->title_blog ?></a></td>
                            <td><?php echo $key->dTime ?></td>
                            <td><?php echo $key->view_blog ?> คน</td>
                            <td><?php echo $count_com->count ?> คอมเมนต์</td>
                            <td><a href="edit_blog.php?id_blog=<?php echo $key->id_blog ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-magic" viewBox="0 0 16 16">
                                ...
                                <a href="delete_blog.php?id_blog=<?php echo $key->id_blog ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16">
