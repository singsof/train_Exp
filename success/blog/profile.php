                    ...
                    <div class="col-12">
                        ...
                        <!-- <form> -->
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?php echo $ROW_MEM->id_code ?>" disabled>
                            </div>
                            <div class="form-group">
                                <label for="name">ชื่อ</label>
                                <input type="text" class="form-control" value="<?php echo $ROW_MEM->name ?>" disabled>
                            </div>
                            <div class="form-group">
                                <label for="name">นามสกุล</label>
                                <input type="text" class="form-control" value="<?php echo $ROW_MEM->last_name ?>" disabled>
                            </div>
                            <div class="form-group">
                                <label for="email">อีเมล</label>
                                <input type="email" class="form-control"  value="<?php echo $ROW_MEM->e_mail ?>" disabled>
                            </div>
                            <div class="form-group">
                                <label for="email">เบอร์</label>
                                <input type="tel" class="form-control"  value="<?php echo $ROW_MEM->phone ?>"disabled >
                            </div>
                            <h5 class="mb-4 font-weight-bold">ข้อมูลล็อกอิน</h5>
                            <div class="form-group">
                                <label for="email">ชื่อผู้ใช้</label>
                                <input type="tel" class="form-control"  value="<?php echo $ROW_MEM->user_name ?>" disabled>
                            </div>
                            <div class="form-group">
                                <label for="email">รหัสผ่าน</label>
                                <input type="password" class="form-control"  value="<?php echo $ROW_MEM->pass ?>"disabled >
                            </div>
                            <div class="form-group">
                                <button onclick="location.assign('./edit_profile.php?id=<?php echo $ROW_MEM->id_mem   ?>')" class="btn btn-primary">แก้ไข</button>
                            </div>
                        <!-- </form> -->
                    </div>
                </div>
