        ...
        <div class="content">
            ...
            <div class="container bg-white pt-5">
                ...
                <div class="row blog-item px-3 pb-5">
                    ...
                    <div class="col-md-7">
                        <h3 class="mt-md-4 px-md-3 mb-2 py-2 bg-white font-weight-bold">หัวข้อโพสต์</h3>
                        <div class="d-flex mb-3">
                            <small class="mr-2 text-muted"><i class="fa fa-calendar-alt"></i> Wednesday June 15 2022</small>
                            <small class="mr-2 text-muted"><i class="fa fa-folder"></i> ชื่อ นามสกุล</small>
                            <small class="mr-2 text-muted"><i class="fa fa-comments"></i> 15 คอมเมนต์</small>
                        </div>
                        <p>
                            รายละเอียดข้อความโดยย่อ
                        </p>
                        <a class="btn btn-link p-0" href="detail_blog.php">อ่านเพิ่มเติม<i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
